...
/* Matrix transpose function [n*m -> m*n] */
...
/* Random number in range of <+-0.0001> */
double Matrix::generateRandomNumber() {
	std::random_device rd;
	std::mt19937 gen(rd());
	std::uniform_real_distribution<> dis(-.0001, 000.1);

	return dis(gen);
}

/* Debug tool for printing values to console */
